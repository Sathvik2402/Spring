...
public class AppController {
	...
	public String getWeather1(Map<String, Object> map, Model model) {
		...
		String uri = "https://api.openweathermap.org/data/2.5/weather?zip=" + zcode + "," + ccode + "&appid=" + apiKey
				+ "&units=metric";
		RestTemplate rt = new RestTemplate();
		Root now = rt.getForObject(uri, Root.class);
		String hourly = "https://api.openweathermap.org/data/2.5/forecast?lat=" + now.getCoord().getLat() + "&lon="
				+ now.getCoord().getLon() + "&appid=" + apiKey + "&units=metric";
...
//			System.out.println("AppController.getWeather2().ifField");
				String apiKey = "5459fc65a8045f0fae1fa9ed93f1564a";
				String zcode = "507001", ccode = "IN";
				String uri = "https://api.openweathermap.org/data/2.5/weather?zip=" + zcode + "," + ccode + "&appid="
						+ apiKey + "&units=metric";
				RestTemplate rt = new RestTemplate();
				Root now = rt.getForObject(uri, Root.class);
				String hourly = "https://api.openweathermap.org/data/2.5/forecast?lat=" + now.getCoord().getLat()
						+ "&lon=" + now.getCoord().getLon() + "&appid=" + apiKey + "&units=metric";
		...
		String apiKey = "5459fc65a8045f0fae1fa9ed93f1564a";
		String uri = "https://api.openweathermap.org/data/2.5/weather?zip=" + form.getZcode() + "," + form.getCcode()
