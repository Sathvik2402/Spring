...
public class EmployeeOpsController {
	...
	@GetMapping("/page_report")//form submission
	public String showReportByPage(Map<String,Object> map,@PageableDefault(page = 0,size = 4,direction =Sort.Direction.ASC)Pageable pageable) {
		Page<Emp> page=serv.fechEmplByPageNo(pageable);
		map.put("list",page);
		return "show_report";
	}
}
